...
export function BlogLayoutTwo({ blog }: Props) {
    ...
    return (
        <div className="group grid grid-cols-12 gap-4 items-center text-dark dark:text-light">
            ...
            <div className="col-span-8 w-full">
                <span className="inline-block w-full uppercase text-accent dark:text-accentDark font-semibold text-xs sm:text-sm">{(blog.tags as string[])[0]}</span>
